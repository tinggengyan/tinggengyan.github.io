...
![Java 内存模型抽象示意图](http://cdn.infoqstatic.com/statics_s2_20170111-0710/resource/articles/java-memory-model-1/zh/resources/11.png)
...
![内存模型案例](http://cdn4.infoqstatic.com/statics_s2_20170111-0710/resource/articles/java-memory-model-1/zh/resources/22.png)
...
![处理器指令](http://o9mhbhxlj.bkt.clouddn.com/JMMprocessor_1.png)

假设处理器 A 和处理器 B 按程序的顺序并行执行内存访问，最终却可能得到 x = y = 0 的结果。具体的原因如下图所示：

![程序的顺序](http://cdn4.infoqstatic.com/statics_s2_20170111-0710/resource/articles/java-memory-model-1/zh/resources/44.png)
...
![重排序类型](http://o9mhbhxlj.bkt.clouddn.com/JMM_ReOrder.png)
...
![内存屏障](http://o9mhbhxlj.bkt.clouddn.com/JMM_Barriers.png)
